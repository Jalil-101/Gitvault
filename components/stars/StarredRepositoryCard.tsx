// components/stars/StarredRepositoryCard.tsx
...
interface StarredRepositoryCardProps {
  repository: StarredRepository;
  onPress?: () => void;
}

export const StarredRepositoryCard: React.FC<StarredRepositoryCardProps> = ({
  repository,
  onPress,
}) => {
  const { colors, shadows, isDarkTheme } = useModernTheme();
  const { toggleStar } = useStarsStore();
      ...
      <View style={styles.metadata}>
        ...
        <View style={styles.forkContainer}>
          <Ionicons
            ...
            color={colors.text.tertiary}
          />
          <Text style={[styles.forkCount, { color: colors.text.tertiary }]}>
...
export default StarredRepositoryCard;
